...
import { arrayToObject, objectToArray, rollToChat } from '@/utility'
...
const sheetStore = () => {
  ...
  watch(
    ...
    ([newStrength, newExceptional, newIntelligence, newWisdom, newDexterity, newConstitution, newCharisma]) => {
  ...
  const comeliness = computed(() => com_base.value + cha_comeliness_adj.value + com_racial_adj.value)
